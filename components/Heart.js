...
const Path = styled.path`
  fill:${(props) => (props.isLiked ? '#D15757' : 'transparent')};
  stroke:${(props) => (props.isLiked ? 'transparent' : '#D15757')};
  /* stroke:#D15757; */
  stroke-width:${(props) => (!props.isLiked ? '1px' : '0')};
`

function SvgHeart(props) {
  const { isLiked, className } = props
  return (
    <Svg
      width="1em"
      height="1em"
